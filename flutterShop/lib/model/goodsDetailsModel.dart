class GoodsDetailsModel {
  String code;
  String message;
  GoodDetailsData data;

  GoodsDetailsModel({this.code, this.message, this.data});

  GoodsDetailsModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null
        ? new GoodDetailsData.fromJson(json['data'])
        : null;
  }
...
class GoodDetailsData {
  GoodInfo goodInfo;
  List<GoodComments> goodComments;
  AdvertesPicture advertesPicture;

  GoodDetailsData({this.goodInfo, this.goodComments, this.advertesPicture});

  GoodDetailsData.fromJson(Map<String, dynamic> json) {
